...
def main():
    ...
    parser.add_argument('--color', type=str, default=None, help='Object color (red, green, blue, yellow, orange, purple, white, black, grey).')
    parser.add_argument('--mass', type=str, default=None, help='Object mass in kg.')
    parser.add_argument('--size', type=str, default=None, help='Cube side length in meters.')
    parser.add_argument('--radius', type=str, default=None, help='Sphere/cylinder radius in meters.')
    parser.add_argument('--length', type=str, default=None, help='Cylinder length in meters.')
    parser.add_argument('--size_x', type=str, default=None, help='Box X dimension in meters.')
    parser.add_argument('--size_y', type=str, default=None, help='Box Y dimension in meters.')
    parser.add_argument('--size_z', type=str, default=None, help='Box Z dimension in meters.')
    ...
    # Build xacro mappings with all provided parameters
    mappings = {"name": args.name}
    
    if args.color is not None:
        mappings["color"] = args.color
    if args.mass is not None:
        mappings["mass"] = args.mass
    if args.size is not None:
        mappings["size"] = args.size
    if args.radius is not None:
        mappings["radius"] = args.radius
    if args.length is not None:
        mappings["length"] = args.length
    if args.size_x is not None:
        mappings["size_x"] = args.size_x
    if args.size_y is not None:
        mappings["size_y"] = args.size_y
    if args.size_z is not None:
        mappings["size_z"] = args.size_z
